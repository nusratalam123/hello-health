...
export function HealthSuggestionForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    try {
      const response = await axios.post('https://hello-health-backend.vercel.app/api/health/suggestion', {
        method: 'POST',
        headers: {
      ...
      // Submit health data
      await axios.post('https://hello-health-backend.vercel.app/api/health/submit', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
